...
const s_filterReplacement = '*:･ﾟ✧*:･ﾟ✧'; // Change what filtered words are censored with (**** is the default)
...
const v_formHtml = `
    ...
    <div id="c_imageWrapper" class="c-inputWrapper">
        ...
        <input class="c-input c-imageInput" name="entry.${s_imageId}" id="entry.${s_imageId}" type="url" pattern="https://.*" onchange="previewImg()" placeholder="Image Link (Option)">
    </div>
